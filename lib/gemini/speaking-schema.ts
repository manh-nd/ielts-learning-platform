import { SpeakingEvaluationTraceSchema } from "@/modules/speaking/application/practice-feedback";
export {
  SpeakingEvaluationTraceSchema,
  type SpeakingEvaluationTrace,
  PracticeFeedbackPointSchema,
  type PracticeFeedbackPoint,
  PracticeFeedbackSchema,
  type PracticeFeedback,
  PracticeEvaluationResultSchema,
  type PracticeEvaluationResult,
} from "@/modules/speaking/application/practice-feedback";
import { z } from "zod";
...
/**
 * ============================================================================
 * SPEAKING PRACTICE FEEDBACK SCHEMAS (Part 1 Practice MVP - Issue #56)
 * ============================================================================
 */
...
export const practiceFeedbackJsonSchema = {
  ...
  properties: {
    evidenceScope: {
      type: "object",
      properties: {
        mode: { type: "string", enum: ["part_1", "part_2", "part_3"] },
        responseCount: { type: "integer" },
      },
      required: ["mode", "responseCount"],
    },
    ...
    strengths: {
      ...
      items: {
        type: "object",
        properties: {
          criterion: { type: "string", enum: ["FC", "LR", "GRA", "PR"] },
    ...
    evidenceSufficiency: {
      type: "string",
      enum: ["sufficient_for_practice_feedback", "limited"],
    },
  },
  required: [
    "evidenceScope",
